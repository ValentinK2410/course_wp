...
define('COURSE_PLUGIN_VERSION', '1.6.2');
...
class Course_Plugin {
    ...
    private function includes() {
        ...
        $files = array(
            ...
            'includes/class-course-enroll-modal-admin.php', // HTML модального окна записи на программу
            ...
            'includes/class-course-bank-transfer.php', // Шорткод перевода / оплаты Сбербанк [mbs_bank_transfer]
            'includes/class-course-sberbank-payment-admin.php', // Настройки платёжного шлюза Сбербанка
            ...
            'includes/class-course-hero-catalog-nav.php', // Навигация по соседним курсам/программам на hero
            ...
            'includes/class-course-db-search-replace-admin.php', // Инструмент: поиск/замена в таблицах БД (Инструменты)
        );
    ...
    public function load_components() {
        ...
        if (class_exists('Course_Enroll_Modal_Admin')) {
            Course_Enroll_Modal_Admin::get_instance();
        }

        if (class_exists('Course_DB_Search_Replace_Admin')) {
            Course_DB_Search_Replace_Admin::get_instance();
        }
        ...
        if (class_exists('Course_Sberbank_Payment_Admin')) {
            Course_Sberbank_Payment_Admin::get_instance();
        }
